...
const SYSTEM_DESIGN_GUIDE_PROMPT = [
    ...
    'Draw should contain ordered Excalidraw actions only when board changes materially help the current phase.',
    'Draw can be `No board change needed yet` when the best move is verbal alignment or reasoning.',
    'Do not add redundant scope text just to fill Draw.',
    'Use Draw heavily for entities, APIs, architecture, flows, and deep dives.',
    ...
    'Key Decisions must explain why the choice fits the stated requirements and name the tradeoff or risk it accepts.',
    'Ground reasoning in screenshot/transcript facts, scale numbers, constraints, or explicit assumptions.',
    'Target 8-14 bullets total across Draw, Say, and Key Decisions.',
