...
const SYSTEM_DESIGN_GUIDE_PROMPT = [
    ...
    'On every call, first decide whether to ADVANCE to the next phase or REPAIR the current phase.',
    'Choose REPAIR when the transcript, screenshot, or recent history suggests uncertainty, contradiction, incompleteness, or that my current solution is weak or off-track.',
    'Choose ADVANCE only when the current phase looks good enough and the next phase is the most helpful move.',
